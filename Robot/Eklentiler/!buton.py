...
async def buton(client:Client, message:Message):
    ...
    butonlar = {
        "Beni Yazan" : "t.me/poyraz2103",
        "POLESTAR"      : "t.me/POLESTAR_CHAT"
    }
...
@Client.on_callback_query(filters.regex(pattern=r"^t.me/poyraz2103$"))
async def keyif_data(client, callback_query):
    await callback_query.answer('t.me/poyraz2103 a bastın kanka', show_alert=True)

@Client.on_callback_query(filters.regex(pattern=r"^t.me/POLESTAR_CHAT$"))
async def yksl_data(client, callback_query):
    await callback_query.answer('t.me/POLESTAR_CHAT e bastın kanka', show_alert=True)
